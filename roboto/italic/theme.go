...
var (
	RobotoThin   = text.Font{Typeface: Roboto, Variant: "", Style: text.Italic, Weight: text.Thin}
	RobotoLight  = text.Font{Typeface: Roboto, Variant: "", Style: text.Italic, Weight: text.Light}
	RobotoNormal = text.Font{Typeface: Roboto, Variant: "", Style: text.Italic, Weight: text.Normal}
	RobotoMedium = text.Font{Typeface: Roboto, Variant: "", Style: text.Italic, Weight: text.Medium}
	RobotoBold   = text.Font{Typeface: Roboto, Variant: "", Style: text.Italic, Weight: text.Bold}
	RobotoBlack  = text.Font{Typeface: Roboto, Variant: "", Style: text.Italic, Weight: text.Black}
)
